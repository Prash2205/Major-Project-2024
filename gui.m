classdef gui < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function EmbedButtonPushed(app, ~)
            ...
            % Apply the selected watermark attack
            selectedAttack = app.AttackDropDown.Value;
            app.Logic.applyWatermarkAttack(selectedAttack);
        ...
        % Value changed function: AttackDropDown
        function AttackDropDownValueChanged(~, ~)
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Create AttackDropDown
            app.AttackDropDown = uidropdown(app.ResultsPanel);
            app.AttackDropDown.Items = {'No Attack', 'Gaussian Noise','Salt and Pepper','Speckle','Sharpen','Motion','Average Filter'};
            app.AttackDropDown.ValueChangedFcn = createCallbackFcn(app, @AttackDropDownValueChanged, true);
            app.AttackDropDown.Position = [150 66 100 22];
            app.AttackDropDown.Value = 'No Attack';
